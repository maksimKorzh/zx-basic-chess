...
530 IF ((PIECES(BOARD(SQUARE))&32)=32)=SIDE THEN GOTO 540 ELSE CONTINUE FOR 
...
610 BOARD(SQUARE)=0
620 BOARD(TARGET_SQUARE)=PIECE
630 REM
640 REM
650 REM
651 GOSUB 160
660 BOARD(SQUARE)=PIECE
670 BOARD(TARGET_SQUARE)=CAPTURED_PIECE
671 GOSUB 160
